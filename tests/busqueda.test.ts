...
// EMPIEZO LOS TEST
    ...
    test("busquedaPorTitulo deberia encontrar el titulo", () => {
        const resultado = busqueda.busquedaPorTitulo(tareas, "comida");
    ...
    test("busquedaPorTitulo deberia ignorar las MAYÚSCULAS y minusculas", () => {
        const resultado = busqueda.busquedaPorTitulo(tareas, "ESTUDIAR");
    ...
    test("buscarPorFechaDeVencimiento debería devolver solo las tareas con la fecha exacta", () => {
        ...
        const resultado = busqueda.buscarPorFechaDeVencimiento(tareas, fechaObjetivo);
    ...
    test("busquedaPorFechaVencimiento deberia devolver vacio si no hay coincidencia", () => {
        const resultado = busqueda.buscarPorFechaDeVencimiento(tareas, new Date(2023, 11, 7));
